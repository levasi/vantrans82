...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_7f1ecbce",
      load: () => import('../_/en.mjs' /* webpackChunkName: "locale_en_46json_7f1ecbce" */),
      cache: true
    }
  ],
  ro: [
    {
      key: "locale_ro_46json_658613ce",
      load: () => import('../_/ro.mjs' /* webpackChunkName: "locale_ro_46json_658613ce" */),
      cache: true
    }
  ]
};
...
const _d2TBSUf5I8SVmKjWaUEz88KzDUqGRSs4s5FHB7CJZI = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const _NokDZO8iJcasAYhOWNXRUmy82vb4CYWlazf5ETSZPk = defineNitroPlugin(async (nitroApp) => {
  ...
  try {
    ...
    `);
    const loadTranslationsFromDb = async (lang) => {
...
const plugins = [
  _d2TBSUf5I8SVmKjWaUEz88KzDUqGRSs4s5FHB7CJZI,
_AA9VvhDTx7VOyFlJKvo1o_Afpq7DONlpvAm_hXieM,
_NokDZO8iJcasAYhOWNXRUmy82vb4CYWlazf5ETSZPk
];
...
const _I6WAI3 = _messagesHandlerCached;

const _lazy_2E3m1U = () => import('../routes/api/admin/create-user.post.mjs');
const _lazy_ughfPV = () => import('../routes/api/admin/delete-account.post.mjs');
const _lazy_ODYvNR = () => import('../routes/api/admin/init.post.mjs');
const _lazy_MaOtK1 = () => import('../routes/api/admin/login.post.mjs');
const _lazy_Fiaisp = () => import('../routes/api/admin/settings.get.mjs');
const _lazy_Ak7z1e = () => import('../routes/api/admin/settings.put.mjs');
const _lazy_9eZRbx = () => import('../routes/api/admin/settings/system.get.mjs');
const _lazy_x62EYV = () => import('../routes/api/admin/translations/_lang_.get.mjs');
const _lazy_40qcg1 = () => import('../routes/api/admin/translations/_lang_.patch.mjs');
const _lazy_6JWcCv = () => import('../routes/api/admin/translations/_lang_.put.mjs');
const _lazy_0wayaD = () => import('../routes/api/admin/translations/sync.post.mjs');
const _lazy_U2Me9v = () => import('../routes/api/admin/verify.get.mjs');
const _lazy_FAMnVq = () => import('../routes/api/settings/public.get.mjs');
const _lazy_cNc38e = () => import('../routes/api/translations/_lang_.get.mjs');
const _lazy_L3h0rx = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/admin/create-user', handler: _lazy_2E3m1U, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/delete-account', handler: _lazy_ughfPV, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/init', handler: _lazy_ODYvNR, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/login', handler: _lazy_MaOtK1, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/settings', handler: _lazy_Fiaisp, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/settings', handler: _lazy_Ak7z1e, lazy: true, middleware: false, method: "put" },
  { route: '/api/admin/settings/system', handler: _lazy_9eZRbx, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/translations/:lang', handler: _lazy_x62EYV, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/translations/:lang', handler: _lazy_40qcg1, lazy: true, middleware: false, method: "patch" },
  { route: '/api/admin/translations/:lang', handler: _lazy_6JWcCv, lazy: true, middleware: false, method: "put" },
  { route: '/api/admin/translations/sync', handler: _lazy_0wayaD, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/verify', handler: _lazy_U2Me9v, lazy: true, middleware: false, method: "get" },
  { route: '/api/settings/public', handler: _lazy_FAMnVq, lazy: true, middleware: false, method: "get" },
  { route: '/api/translations/:lang', handler: _lazy_cNc38e, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_L3h0rx, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _I6WAI3, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_L3h0rx, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, getContext as A, baseURL as B, createHooks as C, executeAsync as D, toRouteMatcher as E, createRouter$1 as F, defu as G, getRequestURL as H, getCookie as I, getRequestHeader as J, destr as K, klona as L, createDefu as M, isEqual as N, withoutTrailingSlash as O, parsePath as P, parseQuery as Q, setCookie as R, deleteCookie as S, isEqual$1 as T, withLeadingSlash as U, parseURL as V, stringifyQuery as W, withTrailingSlash as X, listener as Y, getQuery as a, getRouterParam as b, createError$1 as c, defineEventHandler as d, buildAssetsURL as e, appRootTag as f, getDb as g, appRootAttrs as h, initDb as i, getResponseStatusText as j, getResponseStatus as k, appId as l, defineRenderHandler as m, appTeleportTag as n, appTeleportAttrs as o, publicAssetsURL as p, appHead as q, readBody as r, getRouteRules as s, useNitroApp as t, useRuntimeConfig as u, hasProtocol as v, isScriptProtocol as w, joinURL as x, withQuery as y, sanitizeStatusCode as z };
