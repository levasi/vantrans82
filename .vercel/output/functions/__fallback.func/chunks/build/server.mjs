...
import { toRef, isRef, hasInjectionContext, inject, shallowRef, computed, getCurrentInstance as getCurrentInstance$1, defineComponent, createElementBlock, provide, cloneVNode, h, ref, Suspense, Fragment, createApp, createVNode, Text, shallowReactive, onErrorCaptured, onServerPrefetch, unref, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { v as hasProtocol, w as isScriptProtocol, x as joinURL, y as withQuery, z as sanitizeStatusCode, A as getContext, $ as $fetch$1, B as baseURL, C as createHooks, D as executeAsync, c as createError$1, E as toRouteMatcher, F as createRouter$1, G as defu, H as getRequestURL, I as getCookie, J as getRequestHeader, K as destr, L as klona, M as createDefu, N as isEqual, O as withoutTrailingSlash, P as parsePath, Q as parseQuery, R as setCookie, S as deleteCookie, T as isEqual$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index___en",
    path: "/en",
    component: () => import('./index-Ga4lyRya.mjs')
  },
  {
    name: "index___ro",
    path: "/",
  ...
  },
  {
    ...
    component: () => import('./index-D6H0F4cF.mjs')
  },
  {
    name: "admin___ro",
    path: "/admin",
  ...
  },
  {
    ...
    component: () => import('./login-BZz3m33t.mjs')
  },
  {
    name: "admin-login___ro",
    path: "/admin/login",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "admin" } },
    component: () => import('./login-BZz3m33t.mjs')
  },
  {
    ...
    component: () => import('./register-BngXxW11.mjs')
  },
  {
    name: "admin-register___ro",
    path: "/admin/register",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "admin" } },
    component: () => import('./register-BngXxW11.mjs')
  },
  {
    ...
    component: () => import('./settings-BSPaJpZH.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./translations-DCmvhDLC.mjs')
  },
  {
    name: "admin-translations___ro",
...
const namedMiddleware = {
  admin: () => import('./admin-BijC6RZO.mjs')
};
  ...
  en: [
    {
      ...
      load: () => import(
        './en-CrfMafT2.mjs'
        /* webpackChunkName: "locale_en_46json_7f1ecbce" */
      ),
      cache: true
    }
  ],
  ro: [
    {
      ...
      load: () => import(
        './ro-DaCTeSp6.mjs'
        /* webpackChunkName: "locale_ro_46json_658613ce" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/8MCyIYrM"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/8MCyIYrM"}/${locale}/messages.json`));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-oLkOJ2dq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DL4Ogje4.mjs'));
...
export { _export_sfc as _, useState as a, useI18n as b, useRouter as c, useRoute as d, entry_default as default, useNuxtApp as e, useRuntimeConfig as f, nuxtLinkDefaults as g, useRequestEvent as h, defineNuxtRouteMiddleware as i, navigateTo as n, resolveRouteObject as r, useHead as u };
