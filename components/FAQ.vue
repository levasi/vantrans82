<template>
  <section id="faq" class="py-20 md:py-24 bg-gray-50">
      ...
      <div class="space-y-4">
        ...
        >
          <button
            ...
            class="w-full px-6 py-5 flex items-center justify-between text-left hover:bg-gray-50 transition-colors group"
          >
